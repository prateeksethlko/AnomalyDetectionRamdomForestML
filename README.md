Using SkLearn Isolation Forest and Pandas ,and streamlit Plot Charts , aim is to Identify the Unsual Records from a pretrained CSV from a Newly Uploaded File , Compare and
